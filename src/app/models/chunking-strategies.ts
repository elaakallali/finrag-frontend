...
export const CHUNKING_STRATEGIES: ChunkingStrategyOption[] = [
  { label: 'Table aware (recommended)', value: 'table-aware', apiStrategy: 'TABLE_AWARE', usesTokenBudget: false },
  { label: 'Mixed', value: 'mixed', apiStrategy: 'MIXED', usesTokenBudget: false },
